...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-CHANGE-THIS-SECRET-KEY-IN-PRODUCTION-xyz123')
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedCopyWithoutManifestStaticFilesStorage'
